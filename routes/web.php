...
Route::post('/tutorsettings', 'TutorController@tutorsettings');
Route::get('/feed', 'HomeController@feed');
Route::get('/vid', 'HomeController@video');
Route::get('/meeting.html?', 'HomeController@meet');
Route::get('/welcome', 'HomeController@welcome');
Route::get('/help', 'GuestController@Help');
Route::get('/privacy', 'GuestController@privacy');
Route::get('/terms', 'GuestController@Terms');
Route::get('/gsearch', 'GuestController@gsearch');
Route::get('/resetpass', 'HomeController@pass');
...
Route::get('/location', 'NearbyController@meet');

// Messages
Route::get('/direct-messages', 'MessagesController@index');
Route::get('{id?}/direct-messages', 'MessagesController@index');
...
//Flags
Route::get('{id?}/flags', 'Profilecontroller@flag');
Route::get('/flags', 'Profilecontoller@flags');
